            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">
                        <Trans i18nKey="sections.wave.title" components={{ 0: <span className="text-quantum-accent">Onda</span> }} />
                    </h2>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="wave-animation">
                                <div className="w-64 h-64 bg-gradient-to-br from-quantum-accent to-cyan-400 rounded-full flex items-center justify-center glow">
                                    <div className="text-center">
                                        ...
                                        <p className="text-lg font-bold">{t('waveSection.wave')}</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className="bg-gray-800 rounded-2xl p-8 border border-quantum-accent/20">
                            <h3 className="text-2xl font-bold mb-6 text-quantum-accent">{t('waveSection.characteristics')}</h3>
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    ...
                                    <span><strong>{t('waveSection.wavelength.title')}:</strong> {t('waveSection.wavelength.description')}</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 bg-quantum-accent rounded-full flex items-center justify-center mr-3 mt-1 flex-shrink-0">
                                        <i className="fas fa-check text-xs"></i>
                                    </div>
                                    <span><strong>{t('waveSection.frequency.title')}:</strong> {t('waveSection.frequency.description')}</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 bg-quantum-accent rounded-full flex items-center justify-center mr-3 mt-1 flex-shrink-0">
                                        <i className="fas fa-check text-xs"></i>
                                    </div>
                                    <span><strong>{t('waveSection.diffraction.title')}:</strong> {t('waveSection.diffraction.description')}</span>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-6 h-6 bg-quantum-accent rounded-full flex items-center justify-center mr-3 mt-1 flex-shrink-0">
                                        <i className="fas fa-check text-xs"></i>
                                    </div>
                                    <span><strong>{t('waveSection.interference.title')}:</strong> {t('waveSection.interference.description')}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
